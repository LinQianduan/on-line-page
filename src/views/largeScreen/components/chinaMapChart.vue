...
export default defineComponent({
	setup (props, { expose }) {
		...
		const initChart = () => {
			let chartDom = chinaMapRef.value!;
					...
					itemStyle: {
						normal: {
							...
							areaColor: {
								...
								colorStops: [{
									offset: 0,
									color: 'rgba(14, 92, 210, 0.2)' // 0% 处的颜色
								}, {
									offset: 1,
									color: '#044BB5' // 100% 处的颜色
								}],
			...
			return (
				<>
					<div class='china-echarts'>
						<div class="dataScreen-map-title">交通大数据分析平台</div>
						<div class='china-map-box' ref={chinaMapRef} id='main'></div>
					</div>
				</>
			)
		}
