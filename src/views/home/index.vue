          ...
          <div class="left-bottom anm6">
            <div class="icon-list">
              <div
                class="icon-item"
                @click="setBgImgInit"
                @mousemove="iconMousemove('switch')"
                @mouseout="iconMouseout"
              >
                <SvgIcon
                  name="switch"
                  :iconStyle="{ ...iconStyle, width: '34px', height: '34px' }"
                />
              </div>
              <div
                class="icon-item"
                @click="getToGithub"
                @mousemove="iconMousemove('github')"
                @mouseout="iconMouseout"
              >
              ...
              <div
                class="icon-item"
                @click="leaveInfo"
                @mousemove="iconMousemove('information')"
                @mouseout="iconMouseout"
              >
                <SvgIcon
                  name="information"
                  :iconStyle="{ ...iconStyle, width: '38px', height: '38px' }"
                />
              </div>
              <div
                class="icon-item"
                @click="leaveNavigation"
                @mousemove="iconMousemove('navigation')"
                @mouseout="iconMouseout"
              >
                <SvgIcon
                  name="three"
              ...
              <div
                class="icon-item"
                @click="leaveScreen"
                @mousemove="iconMousemove('largeScreen')"
                @mouseout="iconMouseout"
              >
                <SvgIcon
                  name="large-screen"
                  :iconStyle="{ ...iconStyle, paddingTop: '2px' }"
                />
              </div>
            </div>
        ...
        <div class="con-right">
          <div class="module">
            ...
            >
              ...
              <div class="hitokoto-all" @click="switchHitokotoFn">
                <div class="hitokoto-text">
                  <span id="hitokoto_text">{{ hitokoto.hitokoto }}</span>
                </div>
            ...
            >
              ...
              <div class="weather">
                <a href="javascript:void(0)" @click="openSearchReg">{{
                  region
                }}</a>
                &nbsp;&nbsp; &nbsp;
...
const iconMousemove = (type?: string) => {
  if (type === "switch") {
    ...
    iconDescription.value = "three.js";
