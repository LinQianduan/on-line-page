...
.fade-bounce-y-enter-active {
  transition: all 0.2s cubic-bezier(0, 1.8, 1, 1.2);
}
...
#Aurora-Dia--body {
  ...
  --aurora-dia--linear-gradient: linear-gradient(130deg,#24c6dc,#5433ff 41.07%,#f09 76.05%); /* linear-gradient(to bottom, #5fc, #1a8) */
  --aurora-dia--linear-gradient-hover: linear-gradient(to bottom, #25b0cc, #3f60de);
  --aurora-dia--platform-light: #b712ac;
  --strong-gradient: linear-gradient(62deg,#87c2fd,#dcb9fc)!important;
